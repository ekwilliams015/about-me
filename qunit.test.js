...
QUnit.test('TEST add', assert => {
  assert.equal(addNumbers(1, 1), 2, 'Positive integers')
  assert.equal(addNumbers(-1, -1), -2, 'Negative integers')
  assert.equal(addNumbers(-10, 10), 0, 'Mixed')
  assert.equal(addNumbers(23, -42), -19, 'Mixed2')
})
